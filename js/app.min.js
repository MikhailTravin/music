...
class AudioPlayer {
	constructor(el, options) {
		...
		this.icons = {
			pause: `<svg width="20" height="20" viewBox="0 0 17 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<title>Page 1</title>
...
`,
	...
	getTimestamp(totalSeconds) {
		...
		const result = `${minutes < 10 ? "0" + minutes : minutes}:${seconds < 10
			? "0" + seconds
			: seconds}`;
	...
	updateTimestamp() {
		let timestamp = this.audio.duration - this.audio.currentTime;
...
const playerTwo = new AudioPlayer(".audioPlayer-two", {
	source:
		"https://s3-us-west-2.amazonaws.com/s.cdpn.io/355309/Swing_Jazz_Drum.mp3"
});

const playerTree = new AudioPlayer(".audioPlayer-tree", {
	source:
		"https://s3-us-west-2.amazonaws.com/s.cdpn.io/355309/Swing_Jazz_Drum.mp3"
});
